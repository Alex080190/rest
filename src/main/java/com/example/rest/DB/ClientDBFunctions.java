...
//        conn = DriverManager.getConnection("jdbc:postgresql://192.168.1.79:5432/" + dbName, user, password);
//        conn = DriverManager.getConnection("jdbc:postgresql://172.18.0.2:5432/" + dbName, user, password);
